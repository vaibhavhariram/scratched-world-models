...
CREATE OR REPLACE FUNCTION logistics.get_buildings_in_bbox(
    p_west FLOAT, p_south FLOAT, p_east FLOAT, p_north FLOAT,
    p_min_score FLOAT DEFAULT 0, p_max_score FLOAT DEFAULT 1,
    ...
    FROM (
        SELECT json_build_object(
            ...
            'properties', json_build_object(
                ...
                'entrance_count', (
                    SELECT COUNT(*) FROM logistics.entrance_candidates ec
                    WHERE ec.building_id = b.id
                ),
...
-- Get entrance candidates in bbox
